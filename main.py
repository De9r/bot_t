...
def boten(message):
    ...
    M = types.InlineKeyboardButton('DEV', url='https://t.me/jj8jjj8')
...
def masg(call):
	...
	if call.data =="N_B_1":
		...
		M = types.InlineKeyboardButton('قناه البوت', url='https://t.me/cn_world')
		...
		while True:
			...
			u2 = str(us)+str(bs)+str(us)+str(us)+str(us)
			u3 = str(us)+str(us)+str(bs)+str(us)+str(us)
			u4 = str(us)+str(us)+str(us)+str(bs)+str(us)
			u5 = str(us)+str(us)+str(us)+str(us)+str(bs)
			h = [u2,u3,u4,u5]
			li = random.choice(h)
			url = "https://t.me/"+li
			headers = {
		...
		while True:
			us = str(''.join(random.choice(xu)for i in range(1)))
			un = str(''.join(random.choice(xu)for i in range(1)))
			ua = str(''.join(random.choice(xu)for i in range(1)))
			username = str(us)+"_"+str(un)+"_"+str(ua)
			url = "https://t.me/"+str(username)
			headers = {
            "User-Agent": generate_user_agent(),
		...
		while True:
			...
			if response.text.find('If you have <strong>Telegram</strong>, you can contact <a class="tgme_username_link"')>=0:
				...
				R = types.InlineKeyboardButton(f'{sk}', callback_data="1x")
				K_8_U = types.InlineKeyboardButton('DEV', url='https://t.me/jj8jjj8')
